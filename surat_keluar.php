...
<br>
 <div class="container">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="surat_keluar.php">Surat Keluar</a>
        </li>
        ...
        <br>
        <div class="">
    <center><a class = "btn btn-primary" href = "tambah_suratkeluar.php">Tambah Surat</a></center>
    </div>
    <br>
    <div class="card">
        <div class="card-body">
        ...
        <tbody>
            <?php
                $query = "SELECT * FROM tb_suratkeluar ORDER BY id ASC";
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class = "button2" href ="proses_hapus_keluar.php?id=<?php echo $row['id'];?>"onclick = "return confirm('Yakin jika Data yang anda pilih akan dihapus ?')">Hapus</a>
                    </td>
                </tr>
             <?php
             $nomor++;
